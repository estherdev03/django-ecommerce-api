...
class TestProductModel:
    ...
    def test_return_category_active_only_true(self, product_factory):
...
class TestProductLineModel:
    def test_str_method(self, product_line_factory):
        x = product_line_factory.create(sku="12345")
    ...
    def test_return_category_active_only_true(self, product_line_factory):
...
class TestProductImageModel:
    def test_str_method(self, product_image_factory, product_line_factory):
        ...
        x = product_image_factory(url="test.jpg", product_line=obj)
        assert x.__str__() == "12345_img"
    ...
    def test_alternative_text_field_length(self, product_image_factory):
        ...
        with pytest.raises(ValidationError):
            product_image_factory(alternative_text=alternative_text).clean()
